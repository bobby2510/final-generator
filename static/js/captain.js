...
let team_list=sd.req_data[series_index].teams_list
    ...
    team1_data.forEach((player)=>
    {
        ...
        outer_div.classList.add('d-flex','selected-player-outer-div','justify-content-between','align-items-center','border-grey','captain_team_one_data')
    ...
    team2_data.forEach((player)=>
    {
        ...
        outer_div.appendChild(img)
        outer_div.appendChild(inner_div1)
        outer_div.classList.add('d-flex','selected-player-outer-div','justify-content-between','align-items-center','border-grey','captain_team_two_data')
