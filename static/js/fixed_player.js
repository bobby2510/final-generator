let get_fixed_players = function(team1,team2,index_one_list,index_two_list,series_index)
{
    ...
    team_one = document.getElementById('fixed_team_one')
    team_two = document.getElementById('fixed_team_two')
    team_one_head = document.getElementById('fixed_team_one_head')
    team_two_head = document.getElementById('fixed_team_two_head')
    ...
    team1_data.forEach((player)=>
    {
        ...
        outer_div.classList.add('d-flex','selected-player-outer-div','justify-content-between','align-items-center','border-grey','fixed_team_one_data')
    ...
    team2_data.forEach((player)=>
    {
        ...
        outer_div.appendChild(img)
        outer_div.appendChild(inner_div1)
        outer_div.classList.add('d-flex','selected-player-outer-div','justify-content-between','align-items-center','border-grey','fixed_team_two_data')
        team_two.appendChild(outer_div)
    })
    team_one_data = document.querySelectorAll('.fixed_team_one_data')
    team_two_data = document.querySelectorAll('.fixed_team_two_data')
